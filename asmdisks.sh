...
select name, total_mb, COLD_USED_MB USED_MB, free_mb, ROUND((1-(free_mb / total_mb))*100, 2) "%FULL" from v\$asm_diskgroup;
...
echo ""
echo "----------------------------"
echo "ASM DISKS OS MOUNTS & LABELS:"
echo "----------------------------"
echo -e "\033[32;5mIT'S HIGHLY RECOMMENDED TO RUN THIS COMMAND BY ROOT AS SOME DISKS MAY BE MISSING \033[0m[${FILE_NAME} |sort -k 2 -t:|grep oracleasm]"
echo ""
